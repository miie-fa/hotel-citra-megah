...
<body style="background-image: url({{ asset('image/bg-auth.jpg') }})">
    ...
    <div class="container">
        ...
        <div class="paper">
            ...
            <div class="success-description">
                Pembayaran kamu dengan Ipaymu Berhasil, Silahkan cek inbox email dari kami untuk detail pesanan !!
            </div>
            <div class="order-details">
                <div class="order-number-label">Payment Method</div>
                <div class="order-number">IPAYMU</div>
            </div>
            <div class="order-footer"><a href="{{ route('home') }}">Return to home!</a></div>
            </div>
