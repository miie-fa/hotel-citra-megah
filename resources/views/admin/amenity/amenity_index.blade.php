    ...
    <div class="row">
        <div class="col-md-12">
            <div class="mb-4 col-12 col-xl-8 mb-xl-2">
                <h3 class="font-weight-bold">Amenities</h3>
            </div>
            <div class="card">
                <div class="card-body">
                                ...
                                @foreach ($amenities as $key => $item)
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            ...
                                            <a href="{{ route('amenity.edit', $item->id) }}" class="btn btn-sm text-light btn-info">Edit</a>
                                            <form action="{{ route('amenity.destroy', $item->id) }}" method="POST" style="display:inline-block">
                                                @csrf
                                                @method('DELETE')
